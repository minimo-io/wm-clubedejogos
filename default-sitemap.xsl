...
<xsl:stylesheet version="2.0" xmlns:html="http://www.w3.org/TR/html40" xmlns:sitemap="http://www.sitemaps.org/schemas/sitemap/0.9" xmlns:image="http://www.google.com/schemas/sitemap-image/1.1" xmlns:xsl="http://www.w3.org/1999/XSL/Transform">
	...
	<a href="https://clubedejogos.com"><span>Início</span></a>
	...
	<a href="https://clubedejogos.com"><span>Início</span></a>
			...
			<svg width="6" height="8" fill="none" xmlns="http://www.w3.org/2000/svg"><path d="M.727 7.06L3.78 4 .727.94l.94-.94 4 4-4 4-.94-.94z" fill="#141B38"/></svg>
					...
					<a href="https://clubedejogos.com/sitemap.xml"><span>Índice do sitemap</span></a>
						<svg width="6" height="8" fill="none" xmlns="http://www.w3.org/2000/svg"><path d="M.727 7.06L3.78 4 .727.94l.94-.94 4 4-4 4-.94-.94z" fill="#141B38"/></svg>
	...
	<div id="content-head">
		...
		<xsl:if test="$amountOfURLs &gt; 0">
			<p>
				...
				e foi gerado em outubro 27, 2025 às 2:40 pm			</p>
		</xsl:if>
	</div>
</xsl:template>
	...
	<a href="https://clubedejogos.com"><span>Início</span></a>
		...
		<div class="empty-sitemap__buttons">
			<a href="https://clubedejogos.com" class="button">Voltar à página inicial</a>
					</div>
